...
const handleProfileClick = (userId, post = null) => {
  if (userId) {
    ...
    if (currentPath.includes('/view-detail/')) {
      // Coming from view-detail page (author click)
      navigationState.fromViewDetailAuthor = true;
      navigationState.viewDetailPath = currentPath;
      navigationState.verificationKey = "author_from_view_detail_123";
    } else if (currentPath.includes('/home') || currentPath === '/') {
      // Coming from home page
      navigationState.fromHome = true;
      navigationState.verificationKey = "profile_view_key_123";
    } else if (currentPath.includes('/posts')) {
      // Coming from posts page
      navigationState.fromPosts = true;
      navigationState.verificationKey = "profile_from_posts_123";
    }

    // Include post context if available
    if (post) {
      navigationState.postId = post._id;
      navigationState.postAuthorId = post.author?._id;
    }
        ...
        <div className="max-w-7xl mx-auto">
          <div className="columns-1 sm:columns-1 md:columns-2 lg:columns-3 xl:columns-4 gap-4 sm:gap-5 md:gap-6 space-y-4 sm:space-y-5 md:space-y-6">
            {filteredPosts.map((post, index) => {
                const isAuthorAdmin = isPostAuthorAdmin(post);
                  ...
                  <div className="p-5 pb-3">
                    <div className="flex items-center space-x-4 mb-4">
                      <div className="relative group/avatar flex-shrink-0">
                        ...
                        {isAuthorAdmin && (
                    <div className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        >
                         ...
                         {isAuthorAdmin && (
          <span className="bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs px-2 py-1 rounded-full font-bold shadow-md">
            ADMIN
          </span>
        )}
        </div>
